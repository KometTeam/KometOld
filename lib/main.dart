...
import 'widgets/encryption_startup_gate.dart';
...
Future<void> main() async {
  ...
  // Включаем нативные backend'ы криптографии (AES-GCM на платформенном API)
  // вместо чистого Dart. Существенно ускоряет шифрование на Android/iOS.
  // На Linux/Windows nativных backend'ов нет — пакет молча падает на pure Dart.
  try {
      ...
      builder: (ColorScheme? lightDynamic, ColorScheme? darkDynamic) {
        ...
        return MaterialApp(
          ...
          home: EncryptionStartupGate(
            child: hasToken ? const HomeScreen() : const PhoneEntryScreen(),
          ),
        );
      },
    );
